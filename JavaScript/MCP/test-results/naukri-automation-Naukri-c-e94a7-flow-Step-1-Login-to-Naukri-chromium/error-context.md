...
- Name: naukri-automation.spec.js >> Naukri.com Resume Upload Workflow >> Step 1: Login to Naukri
- Location: tests\naukri-automation.spec.js:218:3
...
- generic [active] [ref=e1]:
  ...
  - paragraph [ref=e3]: "Reference #18.56882c31.1777740997.54cbbf95"
  - paragraph [ref=e4]: https://errors.edgesuite.net/18.56882c31.1777740997.54cbbf95
```
...
```ts
  ...
  140 |     ).first();
  141 |     
  142 |     if (await uploadButton.isVisible({ timeout: 10000 }).catch(() => false)) {
  143 |       console.log('[AGENT] ✓ Found upload resume button');
  144 |       await uploadButton.click();
  145 |       console.log('[AGENT] ✓ Clicked upload resume');
  146 |     } else {
  147 |       console.log('[ERROR] Upload resume button not found');
  148 |       console.log('[INFO] Looking for file input instead');
  149 |       
  150 |       // Try to find file input directly
  151 |       const fileInput = page.locator('input[type="file"]');
  152 |       if (await fileInput.isVisible().catch(() => false)) {
